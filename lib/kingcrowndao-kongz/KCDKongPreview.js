...
export default class KCDKongPreview extends DomNode {
    gameScreen;
    constructor(nftData) {
        super(".kcd-kong-preview.nft-preview");
            ...
            if (category) {
                ...
                if (part?.images) {
                    for (const image of part.images) {
                        ...
                        if (!frame)
                            continue;
                        const sprite = new Sprite(0, 0, "https://api.matedevdao.workers.dev/kingcrowndao-kongz/spritesheet/spritesheet.png", spritesheet, frame).appendTo(this.gameScreen.root);
...
//# sourceMappingURL=KCDKongPreview.js.map