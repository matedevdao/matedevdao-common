...
import { AppCompConfig, Button, ButtonType, SvgIcon, } from "@commonmodule/app-components";
...
export default class SigorSparrowPlayer extends DomNode {
    ...
    async setData(data) {
        ...
        new Button(".speak-dialogue-button", {
            ...
            onClick: () => {
                const utterance = new SpeechSynthesisUtterance(`짹! ${data.traits["Dialogue"]} 짹!`);
