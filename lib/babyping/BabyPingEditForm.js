...
export default class BabyPingEditForm extends DomNode {
    ...
    constructor(nftData) {
        ...
        this.append(this.nftPlayer = new BabyPingPlayer(nftData), this.attributeEditor = new NFTAttributeEditor({
            partOptions: parts,
            baseData: nftData,
            keyToFrame: keyToFrame,
            spritesheet,
            spritesheetImagePath: "https://api.matedevdao.workers.dev/babyping/spritesheet/spritesheet.png",
        }));
        this.attributeEditor.on("dataChanged", (data) => this.nftPlayer.setData(data));
    }
}
//# sourceMappingURL=BabyPingEditForm.js.map